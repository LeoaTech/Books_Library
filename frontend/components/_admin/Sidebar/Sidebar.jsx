...
import routes, { admin_links } from "../../../utiliz";
import { Link, useLocation } from "react-router-dom";
import SidebarLinkGroup from "./SidebarLinkGroup";
import Book from "../../../assets/books2.svg";
import { useUser, useSignOut } from "@gadgetinc/react";
import { BooksIcon, HomeIcon } from "../SVGs";
import user from "../../../assets/user.svg";
import Order from "../../../assets/order2.svg";
import Returns from "../../../assets/returns.svg";
import Shipped from "../../../assets/ship1.svg";
import Deleivered from "../../../assets/order-1.svg";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    // <div className="p-3 w-60 bg-gray-800 flex flex-col text-neutral-50">
    //   <div className="flex items-center gap-2 px-1 py-3">
    //     {/* <img src={Logo} alt="logo" className="h-5 w-5" /> */}
    //     <span>Dashboard</span>
    //   </div>
    //   <div className="flex flex-col py-8 gap-0.5 flex-1">
    //     {routes.map((route, i) => (
    ...
    //       <SidebarLink key={link.path} route={link} />
    //     ))}
    //   </div>
    // </div>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <img src={Book} alt="Books" className="h-5 w-5" />
                  {/* <BooksIcon /> */}
                  Listings
                </Link>
              </li>
              ...
              <li>
                <Link
                  to="/dashboard/qc"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("qc") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <img src={QC} alt="QC" className="h-5 w-5" />
                  QC
                </Link>
              </li>
              {/* <!-- Menu Item Profile --> */}

              {/* <!-- Menu Item Shipping and Returns --> */}
              <SidebarLinkGroup
                activeCondition={
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <img src={Shipping} alt="Orders" className="h-5 w-5" />
                      ...
                      >
                        <ul className="text-bodydark mt-4 mb-5.5 flex flex-col gap-2.5 pl-6 ">
                          <li className="relative flex flex-col hover:text-white">
                            <Link
              ...
              <li>
                ...
                >
                  <img src={Order} alt="Orders" className="h-4 w-4" />
                  Orders
                </Link>
              </li>
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-0.5 flex flex-col gap-2.5 pl-6 text-bodydark">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6 text-bodydark1">
...
{
  /* <div>
            <h3 className="mb-4 ml-4 border-b text-sm font-semibold text-gray">
              MENU
            </h3>
              ...
              <ul className="mb-6 flex flex-col gap-1.5" key={index}>
                ...
                <li className="hover:bg-slate-600 rounded-lg">
                  <Link
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out active:bg-graydark hover:bg-graydark dark:hover:bg-meta-4 `}
